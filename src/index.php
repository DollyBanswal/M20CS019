...
<html lang="en">
<head>
<title>Show users in MySQL server</title>
<meta http-equiv="content-type" content="text/html; charset=iso-8859-1" />
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
</head>
<body>
<div class="container">
<h1>Show users in MySQL server</h1>
<?php
...
if (!($result=mysqli_query($conn,'SELECT user FROM mysql.user')))
    printf("Error: %s\n", mysqli_error($conn));

echo "<h3>All the users of Mysql</h3>";
